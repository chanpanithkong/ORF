...
import logo from '../../assets/images/nbc.png';
...
const LogoMain = ({ reverse }) => {
  ...
  return (
     ...
     */
    <img 
      src={logo} alt="NBC"  height="50px" width="50px"
      fill={theme.palette.mode === 'dark' || reverse ? theme.palette.common.white : theme.palette.common.black}
      fillOpacity="0.85"
    />
    // <>
    //   <svg width="118" height="35" viewBox="0 0 118 35" fill="none" xmlns="http://www.w3.org/20001/svg">
    //     {/* <path
